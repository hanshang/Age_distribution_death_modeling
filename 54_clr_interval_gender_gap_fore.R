...
# state_index: prefecture index
# horizon: forecast horizon
# fmethod: univariate time-series forecasting method

clr_gender_gap_fore <- function(state_index, year_index, horizon, fmethod)
{
    ...
    # take the inverse clr transformation
    
    female_den_fore = as.numeric(invCLR(matrix(female_clr_fore, nrow = 1))) * 10^5
    male_den_fore = as.numeric(invCLR(matrix(male_clr_fore, nrow = 1))) * 10^5
                
    return(list(female_fore = female_den_fore, male_fore = male_den_fore))
}


clr_gender_gap_fore_fun_int <- function(region_index, PDF_M_holdout_data, PDF_F_holdout_data, horizon, uni_fore_method, level_sig)
{
    ...
    {
        dum <- clr_gender_gap_fore(state_index = region_index,
...
clr_gender_gap_ets_int_F = clr_gender_gap_ets_int_M = array(NA, dim = c(n_state, 20, 3), dimnames = list(state, 1:20, c("ECP", "CPD", "MIS")))
for(iwj in 1:n_state)
{
    for(iwk in 1:20)
    {
        dum = clr_gender_gap_fore_fun_int(region_index = iwj, 
        ...
        clr_gender_gap_ets_int_F[iwj,iwk,] = dum$int_F_err
        clr_gender_gap_ets_int_M[iwj,iwk,] = dum$int_M_err
        rm(iwk)
    }
    print(iwj); rm(iwj)
}

horizon_clr_gender_gap_ets_int_F_err_mean = apply(clr_gender_gap_ets_int_F, c(2, 3), mean)
horizon_clr_gender_gap_ets_int_M_err_mean = apply(clr_gender_gap_ets_int_M, c(2, 3), mean)

clr_gender_gap_ets_int_F_err_mean = apply(clr_gender_gap_ets_int_F, c(1, 3), mean)
clr_gender_gap_ets_int_M_err_mean = apply(clr_gender_gap_ets_int_M, c(1, 3), mean)

# fmethod = "arima"

clr_gender_gap_arima_int_F = clr_gender_gap_arima_int_M = array(NA, dim = c(n_state, 20, 3), dimnames = list(state, 1:20, c("ECP", "CPD", "MIS")))
for(iwj in 1:n_state)
{
    for(iwk in 1:20)
    {
        ...
        clr_gender_gap_arima_int_F[iwj,iwk,] = dum$int_F_err
        clr_gender_gap_arima_int_M[iwj,iwk,] = dum$int_M_err
        rm(iwk)
    }
    print(iwj); rm(iwj)
}

horizon_clr_gender_gap_arima_int_F_err_mean = apply(clr_gender_gap_arima_int_F, c(2, 3), mean)
horizon_clr_gender_gap_arima_int_M_err_mean = apply(clr_gender_gap_arima_int_M, c(2, 3), mean)

clr_gender_gap_arima_int_F_err_mean = apply(clr_gender_gap_arima_int_F, c(1, 3), mean)
clr_gender_gap_arima_int_M_err_mean = apply(clr_gender_gap_arima_int_M, c(1, 3), mean)
...
clr_gender_gap_ets_int_F_95 = clr_gender_gap_ets_int_M_95 = array(NA, dim = c(n_state, 20, 3), dimnames = list(state, 1:20, c("ECP", "CPD", "MIS")))
for(iwj in 1:n_state)
{
    for(iwk in 1:20)
    {
        ...
        clr_gender_gap_ets_int_F_95[iwj,iwk,] = dum$int_F_err
        clr_gender_gap_ets_int_M_95[iwj,iwk,] = dum$int_M_err
        rm(iwk)
    }
    print(iwj); rm(iwj)
}

horizon_clr_gender_gap_ets_int_F_95_err_mean = apply(clr_gender_gap_ets_int_F_95, c(2, 3), mean)
horizon_clr_gender_gap_ets_int_M_95_err_mean = apply(clr_gender_gap_ets_int_M_95, c(2, 3), mean)

clr_gender_gap_ets_int_F_95_err_mean = apply(clr_gender_gap_ets_int_F_95, c(1, 3), mean)
clr_gender_gap_ets_int_M_95_err_mean = apply(clr_gender_gap_ets_int_M_95, c(1, 3), mean)

# fmethod = "arima"

clr_gender_gap_arima_int_F_95 = clr_gender_gap_arima_int_M_95 = array(NA, dim = c(n_state, 20, 3), dimnames = list(state, 1:20, c("ECP", "CPD", "MIS")))
for(iwj in 1:n_state)
{
    for(iwk in 1:20)
    {
        ...
        clr_gender_gap_arima_int_F_95[iwj,iwk,] = dum$int_F_err
        clr_gender_gap_arima_int_M_95[iwj,iwk,] = dum$int_M_err
        rm(iwk)
    }
    print(iwj); rm(iwj)
}

horizon_clr_gender_gap_arima_int_F_95_err_mean = apply(clr_gender_gap_arima_int_F_95, c(2, 3), mean)
horizon_clr_gender_gap_arima_int_M_95_err_mean = apply(clr_gender_gap_arima_int_M_95, c(2, 3), mean)

clr_gender_gap_arima_int_F_95_err_mean = apply(clr_gender_gap_arima_int_F_95, c(1, 3), mean)
clr_gender_gap_arima_int_M_95_err_mean = apply(clr_gender_gap_arima_int_M_95, c(1, 3), mean)
