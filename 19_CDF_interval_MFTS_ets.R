...
MFTS_int_fore_subnational_err_F_EVR_ETS = MFTS_int_fore_subnational_err_M_EVR_ETS = array(NA, dim = c(20, 3, 47), dimnames = list(1:20, c("ECP", "CPD", "MIS"), state))
MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para = MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj = 
MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para = MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj = matrix(NA, 20, 47)
for(ij in 1:47)
{
    for(iw in 1:20)
    {
...
rownames(MFTS_int_fore_subnational_err_F_EVR_ETS_mean) = rownames(MFTS_int_fore_subnational_err_M_EVR_ETS_mean) = 1:20

MFTS_int_fore_subnational_err_F_EVR_ETS_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_F_EVR_ETS, c(2, 3), mean))
MFTS_int_fore_subnational_err_M_EVR_ETS_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_M_EVR_ETS, c(2, 3), mean))


# K = 6

MFTS_int_fore_subnational_err_F_K6_ETS = MFTS_int_fore_subnational_err_M_K6_ETS = array(NA, dim = c(20, 3, 47), dimnames = list(1:20, c("ECP", "CPD", "MIS"), state))
MFTS_int_fore_subnational_err_F_K6_ETS_tune_para = MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj = 
MFTS_int_fore_subnational_err_M_K6_ETS_tune_para = MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj = matrix(NA, 20, 47)
for(ij in 1:47)
{
    for(iw in 1:20)
    {
...
rownames(MFTS_int_fore_subnational_err_F_K6_ETS_mean) = rownames(MFTS_int_fore_subnational_err_M_K6_ETS_mean) = 1:20

MFTS_int_fore_subnational_err_F_K6_ETS_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_F_K6_ETS, c(2, 3), mean))
MFTS_int_fore_subnational_err_M_K6_ETS_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_M_K6_ETS, c(2, 3), mean))
...
MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 = MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 = array(NA, dim = c(20, 3, 47), dimnames = list(1:20, c("ECP", "CPD", "MIS"), state))
...
MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95 = MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95 = matrix(NA, 20, 47)
for(ij in 1:47)
{
    for(iw in 1:20)
    {
...
rownames(MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean) = rownames(MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean) = 1:20

MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95, c(2, 3), mean))
MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95, c(2, 3), mean))

# K = 6

MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95 = MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95 = array(NA, dim = c(20, 3, 47), dimnames = list(1:20, c("ECP", "CPD", "MIS"), state))
...
MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95 = MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95 = matrix(NA, 20, 47)
for(ij in 1:47)
{
    for(iw in 1:20)
    {
...
rownames(MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean) = rownames(MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean) = 1:20

MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95, c(2, 3), mean))
MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean_prefecture = t(apply(MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95, c(2, 3), mean))
